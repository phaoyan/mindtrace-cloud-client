...
import StatisticsAnalysisCard from "./analysis/StatisticsAnalysisCard";
import HotspotAnalysisCard from "./analysis/HotspotAnalysisCard";
import GptAnalysisCard from "./analysis/GptAnalysisCard";
...
const ExamAnalysisPanel = () => {
    ...
    const handleRemove = (resultId: number)=>{
        removeExamResult(resultId).then()
